...
const VARIANTS: Record<Variant, string> = {
  hero: "btn-hero border border-white/20 bg-gradient-to-r from-[#38BDF8] via-[#7DD3FC] to-[#F8FAFC] text-[#05070B] shadow-[0_0_28px_rgba(56,189,248,0.22)] hover:shadow-[0_0_36px_rgba(56,189,248,0.34)]",
  primary:
  ...
  danger:
    "border border-[rgba(239,68,68,0.3)] bg-[rgba(239,68,68,0.1)] text-[var(--tone-red)] hover:border-[rgba(239,68,68,0.5)]",
  warning:
    "border border-[rgba(245,158,11,0.3)] bg-[rgba(245,158,11,0.1)] text-[var(--tone-amber)] hover:border-[rgba(245,158,11,0.5)]",
  white:
    "border border-[var(--border-strong)] bg-[var(--text)] text-[var(--background)] hover:opacity-90",
};
